...
- [x] Deploy and start collecting real data
...
- [x] ADR: ActivityWatch integration — Document decision and rationale
...
- [x] `architecture/integrations.md` — Rules engine, push integrations
