...
|---|---|---|---|
| 1 | [`2026-08-09-allocation-streaming-plan.md`](2026-08-09-allocation-streaming-plan.md) | `tt recompute` materializes 2,738,805 events **twice** and folds them on one core | **250.48 s → 269.72 s / 270.95 s (regression); 8.9 GB → ~120 MB (75x, <1 GB target beaten); CPU unchanged at 99% = 1 of 24; parallel union measured at 264.34 s / 267.95 s with CPU still 99%, then reverted** |
