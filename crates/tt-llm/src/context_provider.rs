...
//! turn.
//!
//! This budget mirrors [`crate::fetch`] deliberately. Two tool families do not earn a shared
//! abstraction; unify their mechanics when a third family makes the rule of three.
